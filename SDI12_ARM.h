...
//#include <avr/parity.h>         // optimized parity bit handling  QUITADO PORQUE arm NO LO SOPORTA
...
private:
  ...
  uint8_t parity_even_bit(uint8_t v); // new function for parity AÑADIDA POR MI
